...
namespace WebFinalRamm.Controllers
{
    ...
    public class ComprasController : Controller
    {
        ...
        public ComprasController(FinalRammContext context)
        {
            _context = context;
        }
        ...
        {
            var finalRammContext = _context.Compras.Include(c => c.IdProveedorNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdProveedor,Transaccion,Fecha")] Compra compra)
        {
            if (id != compra.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FinalRammContext.Compras'  is null.");
            }
            var compra = await _context.Compras.FindAsync(id);
            if (compra != null)
            {
